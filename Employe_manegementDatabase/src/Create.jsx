...
const Create = ({ profile, setProfile, setIsToggle }) => {
    ...
    return (
        ...
        >
            ...
            <img src="https://cdn-icons-png.flaticon.com/128/1828/1828595.png" className='h-12 mt-10 cursor-pointer' alt="" onClick={() => setIsToggle(false)} />
        </div>
    );
};
